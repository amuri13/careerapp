...
// API: AI Deep Analysis using gemini-3.8-flash
...
// API: JobDataLake MCP Proxy (https://mcp.jobdatalake.com)
// Supports: search_jobs, get_job, get_company, get_filter_options, find_similar_jobs
